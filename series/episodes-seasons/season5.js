...
let s5e14 = document.getElementById('s5e14');
let s5e15 = document.getElementById('s5e15');
let s5e16 = document.getElementById('s5e16');
...
s5e14.addEventListener('click', function() {
    modifierTitre("Saison 5 - Episode 14");
});
s5e15.addEventListener('click', function() {
    modifierTitre("Saison 5 - Episode 15");
});
s5e16.addEventListener('click', function() {
    modifierTitre("Saison 5 - Episode 16");
});
